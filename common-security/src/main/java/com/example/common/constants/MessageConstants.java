...
public class MessageConstants {
    ...
    public static final String COSTCENTER_STATUS_UPDATED = "CostCenter %s status updated ";
    ...
    public static final String SUBMITTED_TIMESHEET = "Timesheet submitted for employee %s for week starting %s (Month: %s, Year: %s)";
