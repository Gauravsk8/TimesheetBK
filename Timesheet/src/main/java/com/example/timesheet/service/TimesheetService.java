...
public interface TimesheetService {
    ...
    List<TimesheetSummaryResponseDto> getEmployeeTimesheetSummaries(String employeeCode, Integer year, Integer month);    List<DailyTimeSheetResponseDto> getDailyEntries(String employeeCode, Date weekStart) throws TimeSheetException;
